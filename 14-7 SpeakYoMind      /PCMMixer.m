...
//        
//        if (numPackets2 < numPackets1) {
//           // bzero(buffer2 + (numPackets2 * bytesRead), (numPackets1 - numPackets2) * bytesRead);
