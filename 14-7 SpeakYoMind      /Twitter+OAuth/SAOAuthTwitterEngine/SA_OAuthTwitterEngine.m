...
- (NSString *) extractUsernameFromHTTPBody: (NSString *) body {
    ...
    NSArray *keyValueArray_1 = [[tuples objectAtIndex:0] componentsSeparatedByString: @"="];
	
    NSArray *keyValueArray_3 = [[tuples objectAtIndex:1] componentsSeparatedByString: @"="];
	
    // NSArray *keyValueArray_2 = [[tuples objectAtIndex:4] componentsSeparatedByString: @"="];
	
	//NSLog(@"AARRR : Arr 1 %@,Arr 2 %@,Arr 3 %@",keyValueArray_1,keyValueArray_2,keyValueArray_3);
    	...
    	[[NSUserDefaults standardUserDefaults] setObject:[keyValueArray_1 objectAtIndex:1] forKey:@"OATK"];
    	//[[NSUserDefaults standardUserDefaults] synchronize];
    	[[NSUserDefaults standardUserDefaults] setObject:[keyValueArray_3 objectAtIndex:1] forKey:@"OATS"];
    //	[[NSUserDefaults standardUserDefaults] synchronize];
	NSLog(@"S 4EA AT:%@,%@",[keyValueArray_1 objectAtIndex:1],[keyValueArray_3 objectAtIndex:1]);
    
    NSString *strAccessToken=[keyValueArray_1 objectAtIndex:1];
    NSString *strAccessSecrect=[keyValueArray_3 objectAtIndex:1];

    
    NSLog(@"token = %@",strAccessToken);
    NSLog(@"secret = %@",strAccessSecrect);
